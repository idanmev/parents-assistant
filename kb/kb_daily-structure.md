...
## Morning Routine (Hardest Part of the Day)

**Goal:** Get to school with minimal escalation. Not a teaching moment. Not a negotiation. Just movement.

**Fixed rules (non-negotiable):**
- No neighbor play in the morning — "In the morning we only say hi and good morning"
- No open questions ("Do you want to...?") — only statements ("Now we do X")
- One task at a time only — stated as fact, not a list

**Sequence:**
1. Wake up → brief presence, no demands for first 2 minutes
2. "Let's start small" — face wash or socks, not the full list
3. One task named → help physically if needed
4. Next task after previous completed
5. Pre-announce school departure: "In 10 minutes we leave. Let's do shoes now"
6. In car: if she wants music, let her have it. Talking in car is secondary to her preferences

**If she erupts:**
- Stop. Don't push. Let her land.
- Sit near her (not crowding). "I see it's really hard right now."
- Wait for her to name something. Once named → one small step.
- "Okay, so today I'll pick you up early. Now — one shoe at a time."

**If she mentions a peer issue:**
...
**Transition from school to home (first 15 min after pickup):**
- Low demand. Let her decompress.
- If she wants music/silence in car — give it
- If she wants to talk — listen, don't direct
- Confirm 1 concrete plan for the afternoon so she has something to look forward to

**Homework:**
- Best window: before play (if she's still regulated after school)
- If she plays first: 40 min max, then homework before energy crashes
- Setup: write 3–4 tasks on a board. She checks ✓ after each. Gives control + visible progress.
- Parent presence is the key tool now — not timers or cards. Sit nearby.
- "I see you're trying even though it's hard. That's real effort."
...
**Class / activities:**
- If she's reluctant about an activity: "I'll wait for you" / "Your friend will be there" works better than "you have to go"
- Advance prep if unfamiliar activity: "Here's what will happen there..." (brief, calm)
- After class: 5 extra minutes with friends if possible = reduces transition resistance from class → home
...
**During dinner:**
- Minor limit-testing through body (hands in food, cup) → do NOT react sharply. Quiet presence is enough.
...
**Episode time:**
- One episode, clear end. She knows this.
- In Dec 2025 she started independently ending her episode and going to her room without prompting. This is real progress — notice and name it.
- Don't interrupt the episode with tasks. That's her regulated alone time.

---

## Bedtime

**Sequence (reliable, repeat every night):**
1. **5 min talk** — about her day, her feelings, her world. "What was the best moment today?" 
2. **5 min silliness** — tickles, dancing, physical play. Burns final energy. Creates positive physical connection.
3. **Story** — one story. Clear end. "That's our story for tonight."
4. **Sleep music** — starts when story ends. Signal that talking time is over.
5. **Hold the limit** if she asks for more. Repeat once: "That was our story for tonight. I love you." Then quiet.
...
The morning formula Natascha gave:
> **Empathy + calm limit + small steps = stability, security, dramatic drop in morning resistance**

This formula applies to every routine. Not just mornings.
